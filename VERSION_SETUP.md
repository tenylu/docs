...
脚本会自动构建下载链接：
- macOS Apple: `https://cloud.crowmesh.com/crowvpn-apple-2.1.1.dmg`
- macOS Intel: `https://cloud.crowmesh.com/crowvpn-intel-2.1.1.dmg`
- Windows x64: `https://cloud.crowmesh.com/crowvpn-windows-2.1.1-x64-setup.exe`
- Windows Arm64: `https://cloud.crowmesh.com/crowvpn-windows-2.1.1-arm64-setup.exe`
...
1. **在服务器上创建符号链接**
   ...
   ├── crowvpn-apple-2.1.1.dmg  (新版本)
   ├── crowvpn-intel-2.0.1.dmg
   ├── crowvpn-intel-2.1.1.dmg  (新版本)
   ├── crowvpn-windows-2.0.1-x64-setup.exe
   ├── crowvpn-windows-2.1.1-x64-setup.exe  (新版本)
   ├── crowvpn-windows-2.0.1-arm64-setup.exe
   └── crowvpn-windows-2.1.1-arm64-setup.exe  (新版本)
   ```
...
2. **创建符号链接**
   ...
   # 创建 macOS 符号链接
   ln -sf crowvpn-apple-2.1.1.dmg crowvpn-apple-latest.dmg
   ln -sf crowvpn-intel-2.1.1.dmg crowvpn-intel-latest.dmg
   
   # 创建 Windows 符号链接
   ln -sf crowvpn-windows-2.1.1-x64-setup.exe crowvpn-windows-latest-x64-setup.exe
   ln -sf crowvpn-windows-2.1.1-arm64-setup.exe crowvpn-windows-latest-arm64-setup.exe
   ```
...
1. **更新版本配置文件**
   ...
   ```json
   {
     "macos": {
       "apple": {
         "version": "2.1.1",
         "filename": "crowvpn-apple-2.1.1.dmg",
         "url": "https://cloud.crowmesh.com/crowvpn-apple-2.1.1.dmg"
       },
       "intel": {
         "version": "2.1.1",
         "filename": "crowvpn-intel-2.1.1.dmg",
         "url": "https://cloud.crowmesh.com/crowvpn-intel-2.1.1.dmg"
       }
     },
     "windows": {
       "x64": {
         "version": "2.1.1",
         "filename": "crowvpn-windows-2.1.1-x64-setup.exe",
         "url": "https://cloud.crowmesh.com/crowvpn-windows-2.1.1-x64-setup.exe"
       },
       "arm64": {
         "version": "2.1.1",
         "filename": "crowvpn-windows-2.1.1-arm64-setup.exe",
         "url": "https://cloud.crowmesh.com/crowvpn-windows-2.1.1-arm64-setup.exe"
       }
     }
   }
   ```
